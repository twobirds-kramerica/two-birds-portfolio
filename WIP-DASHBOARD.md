...
## 🟠 PLANNED — Scoped, Not Yet Prompted

| # | Project | Initiative | Priority | Effort | Sprint Type | Notes |
|---|---------|-----------|----------|--------|------------|-------|
| 6 | Two Birds / DCC | GEO + AEO Audit & Builds | P2 | Medium | Planning Sprint | Aaron has notes from Mar 25 AI session — dictate to Claude Web first |
| 7 | Digital Confidence Centre | Brenda Instructional Guide | P2 | Medium | Dev Sprint | Interview data loaded in project files |
| 8 | Project Central | WIP Command Centre (proper site) | P2 | Medium | Dev Sprint | This file is the interim — build the real thing when capacity allows |
| 9 | Digital Confidence Centre | B2B White-Label Licensing Strategy | P2 | Medium | Planning Sprint | Libraries, credit unions, banks — highest revenue ceiling |
| 10 | Two Birds | LinkedIn Content Calendar Execution | P2 | Low | Dev Sprint | 39 posts pre-written in Nuclear build output |

---

## 🔴 DEFERRED — Parked Until Further Notice

| # | Project | Initiative | Priority | Reason Parked | Resume Trigger |
|---|---------|-----------|----------|--------------|----------------|
| 11 | HAL Stack | Voice dev rig — Social Stack Diary #1 | P3 | Bandwidth | Return in a few weeks |
| 12 | P3 Accountability Tool | Prototype build | P3 | Post-grant runway | After MRR established |
| 13 | Tools | Email Migration (getkramer → twobirds Gmail) | P3 | After grant deadline | After capacity resets |
| 14 | Tools | Machine Migration (laptop → desktop + i5) | P3 | Time | When physically available |
| 15 | Tools | ShareX Setup (Snagit replacement) | P3 | Time | When machine migrates |
| 16 | Tools | ProtonMail Setup (vault-level email) | P3 | Depends on migration | After machine migration |
| 17 | Tools | Account Security Review (3-account model) | P3 | Depends on migration | After email migration |

---

## ❌ DEPRIORITISED — Removed from Active Queue
...
## 📋 BACKLOG — Ungrouped Items

| Item | Project | Theme | Priority | Notes |
|------|---------|-------|----------|-------|
...
## 🗂️ CLAUDE CHAT MAP
*Where to find the active conversations for each project*
...
## ⚙️ STANDING RULES
- Run `git log --oneline -30` before every Claude Code build session
- Canadian English in all visible text (centre, colour, labour, recognise)
- Static site only — no npm, no Node
- Commit after every phase
- Images: Unsplash only, log every image to `/_image-registry/image-log.md`
- New coding projects: use `https://github.com/twobirds-kramerica/two-birds-project-template` first
- Grants/funding: always verify live dates before acting — never assume open or closed
